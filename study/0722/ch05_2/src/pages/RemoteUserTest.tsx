...
export default function RemoteUserTest() {
    ...
    <section className="mt-4">
        ...
        <div className="flex justify-center mt-4">
            <Button className="btn-sm btn-primary" onClick={getRemoteUser}>GET REMOTE USER</Button>
            <Button className="ml-4 btn-sm btn-accent" onClick={changeName}>CHANGE NAME</Button>
            <Button className="ml-4 btn-sm btn-success" onClick={changeEmail}>CHANGE EMAIL</Button>
            <Button className="ml-4 btn-sm btn-secondary" onClick={changePicture}>CHANGE PICTURE</Button>
        </div>
        {loading && (
        ...
        <div className="flex justify-center p-4 mt-4">
            ...
            <div className="ml-4">
                <p className="text-xl text-bold">{user.name.first} {user.name.last}</p>
